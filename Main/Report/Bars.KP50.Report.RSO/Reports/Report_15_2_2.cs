...
namespace Bars.KP50.Report.RSO.Reports
{
    public class Report1522 : BaseSqlReport
    {
        ...
        {
            get { return "15.2.2 Справка о задолженности для лицевого счета"; }
        }

        public override string Description
        {
            get { return "Справка о задолженности для лицевого счета"; }
        }
        ...
        protected override void PrepareReport(FastReport.Report report)
        {
            ...
            report.SetParameterValue("oper", STCLINE.KP50.Global.Utils.GetCorrectFIO(ReportParams.User.uname));
            report.SetParameterValue("post_oper", postPasport);
        ...
        public override DataSet GetData()
        {
            ...
            if (reader.Read())
            {
                ...
                sql = " SELECT max(case when town ='-' then '' else town end) as town, " +
                      ...
                      " max(" + DBManager.sNvlWord + "(gil,0)) as gil " +
                      " FROM t_ls ";
        ...
        protected override void CreateTempTable()
        {
            string sql = " CREATE TEMP TABLE t_ls ( " +
                               " ob_s char(100),"+// + DBManager.sDecimalType + "(14,2), " +
                               " gil integer, " +
                               " town char(30), " +
                               " rajon char(30), " +
                               " ulica char(40), " +
