...
{
    class Report1510142 : BaseSqlReport
    {
        public override string Name
        {
            get { return "15.10.14.2 Сальдовая оборотная ведомость начислений и оплат по поставщикам"; }
        }
        ...
        {
            get { return Resources.Report_15_10_14_2; }
        }
            ...
            while (reader.Read())
            {
                ...
                if (TempTableInWebCashe(chargeTable))
                {
                    sql = " insert into t_svod (area,geu,nzp_serv,nzp_supp,sum_insaldo,sum_2,rsum_lgota,sum_real,sum_5,sum_outsaldo,sum_nedop,sum_nedop_p, "
                               ...
                               + " select area, geu, nzp_serv, c.nzp_supp, "
                               ...
                               + " where nzp_serv>1 and c.nzp_kvar=k.nzp_kvar "
