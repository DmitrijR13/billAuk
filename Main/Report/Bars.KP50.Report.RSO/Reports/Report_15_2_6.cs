...
{
    public class Report1526 : BaseSqlReport
    {
        public override string Name
        {
            get { return "15.2.6 Выписка из лицевого счета"; }
        }
        ...
        {
            get { return Resources.Report_15_2_6; }
        }
        ...
        public override DataSet GetData()
        {
            ...
            if (reader.Read())
            {
                ...
                sql = " INSERT INTO t_pers_account_1 (ob_s, gil_s, count_room, is_priv, is_komm) " +
                ...
                sql = " INSERT INTO t_pers_account_1 (pasp_gil_count) " +
                ...
                sql = " INSERT INTO t_pers_account_1 (count_progiv) " +
                      " SELECT (select max(pasp_gil_count) FROM t_pers_account_1) + " + DBManager.sNvlWord + "(max(val_prm" + DBManager.sConvToInt + "),0) - count(distinct nzp_gilec) " +
                      " FROM " +
                ...
                sql = " INSERT INTO t_pers_account_1 (sobstv_gil_count) " +
                      " SELECT count(*) " +
                ...
                sql = " INSERT INTO t_pers_account_1 (sobstv_reg_count) " +
                      " SELECT count(*) " +
                ...
                sql = " INSERT INTO t_pers_account_1 (has_naem) " +
                      " SELECT 1 " +
                ...
                sql = " INSERT INTO t_report_15_2_6(fam, ima, otch, sort_sob, type_rod, dat_rog, dat_ofor ) " +
                      " SELECT fam, " +
                             " ima, " +
                             " otch, " +
                             " (CASE WHEN TRIM(TRIM(fam)||' '||TRIM(ima)||' '||TRIM(otch)) = TRIM(fio) THEN 1 ELSE 2 END) AS sort_sob, " +
                             " rodstvo AS type_rod, " +
                             " dat_rog, " +
                             " dat_ofor " +
            ...
            sql = " SELECT TRIM(fam) AS fam, TRIM(ima) AS ima, TRIM(otch) AS otch, TRIM(type_rod) AS type_rod, dat_ofor, dat_rog " +
                  " FROM t_report_15_2_6 " +
                  " ORDER BY sort_sob, 1,2,3 ";
        ...
        {
            string sql = " CREATE TEMP TABLE t_pers_account_1 (     " +
                               " ob_s char(20)," +
                               " gil_s char(20)," +
                               " count_room char(20)," +
                               " is_priv integer," +
            ...
            sql = " CREATE TEMP TABLE t_report_15_2_6( " +
                        " fam CHARACTER(40), " +
                        " ima CHARACTER(40), " +
                        " otch CHARACTER(40), " +
                        " sort_sob INTEGER, " + 
        ...
        {
            ExecSQL(" drop table t_pers_account_1 ", true);
            ExecSQL(" drop table t_report_15_2_6 ");
        }
