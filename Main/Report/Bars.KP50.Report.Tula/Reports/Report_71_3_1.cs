...
{
    public class Report7103001 : BaseSqlReport
    {
        public override string Name
        {
            get { return "71.3.1 Сводный отчет по принятым и перечисленным средствам"; }
        }
        ...
        {
            get { return Resources.Report_71_3_1; }
        }
        ...
        public override DataSet GetData()
        {
            ...
            for (int i = DatS.Year * 12 + DatS.Month; i < DatPo.Year * 12 + DatPo.Month + 1; i++)
            {
                ...
                if (TempTableInWebCashe(distribXx))
                {
                    sql = " INSERT INTO t_distrib (nzp_raj,nzp_serv, nzp_supp, sum_rasp, " +
                          ...
                          " SELECT su.nzp_raj,a.nzp_serv, a.nzp_supp, sum(a.sum_rasp), " +
                          ...
                          " where a.nzp_dom=d.nzp_dom and d.nzp_ul=su.nzp_ul  " +
            ...
            sql = " SELECT sa.payer as agent, sp.payer as principal, " +
                  "        (CASE WHEN TRIM(sr.rajon)='-' THEN TRIM(st.town) ELSE TRIM(sr.rajon) END) as rajon, " +
        ...
        private void InsertMoneyFrom()
        {
            ...
            while (reader.Read())
            {
                ...
                for (int i = DatS.Year ; i <= DatPo.Year; i++)
                {
                    ...
                    sql = " INSERT INTO t_distrib (nzp_raj,nzp_serv, nzp_supp, money_from )" +
                          " SELECT u.nzp_raj, a.nzp_serv, a.nzp_supp, sum(sum_prih)  " +
