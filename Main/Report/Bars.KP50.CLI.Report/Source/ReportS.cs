...
namespace STCLINE.KP50.Client
{
    ...
    public class ReportS
    {
        ...
        protected bool SetKvarAdres(Report rep, int reportID) {
            ...
            if (ret.result && LsInfo != null && LsInfo.Count > 0)
            {
                ...
                else
                {
                    ...
                    rep.SetParameterValue("Lschet_short", LsInfo[0].num_ls);
        ...
        {
            StreamWriter sw = new StreamWriter(@"C:/temp/reportS333.txt", true);
            sw.WriteLine("1");
            ...
            Prm Primech = new Prm();
            Prm finder1 = new Prm();
            sw.WriteLine("CurT_nzp_kvar = " + CurT_nzp_kvar);
            try
            {
                ...
                if (ret.result)
                {
                    sw.WriteLine("SpisPrm.Count = " + SpisPrm.Count.ToString());
                    for (int i = 0; i < SpisPrm.Count; i++)
                    {
                        sw.WriteLine(SpisPrm[i].nzp_prm);
                        #region Разбираем параметры
                        switch (SpisPrm[i].nzp_prm)
                        {
                            case 3:
                                sw.WriteLine(SpisPrm[i].val_prm);
            ...
            try
            {
                ...
                finder11.nzp_user = nzp_user;//web_user.nzp_user;
                finder11.nzp_kvar = CurT_nzp_kvar;
                finder11.nzp = CurT_nzp_dom;
                finder11.pref = CurT_pref;
                finder11.prm_num = 2;
                finder11.rows = 100;
                finder11.month_ = m_;
                finder11.year_ = y_;
                finder11.nzp_prm = 730;
            ...
            try
            {
                ...
                sw.WriteLine("Primech.val_prm = " + Primech.val_prm);
                if ((ret.result == true) & (Primech != null))
                {
            ...
            try
            {
                #region Приватизированность
                Prm finder_f1 = new Prm();
                finder_f1.nzp_user = nzp_user;//web_user.nzp_user;
                finder_f1.nzp_kvar = CurT_nzp_kvar;
                finder_f1.nzp = CurT_nzp_kvar;
                finder_f1.pref = CurT_pref;
                finder_f1.prm_num = 1;
                finder_f1.rows = 10;
                finder_f1.month_ = m_;
                finder_f1.year_ = y_;
                finder_f1.nzp_prm = 2009;

                ret = Utils.InitReturns();
                cli_Prm cliPrm_f1 = new cli_Prm(WCFParams.AdresWcfWeb.CurT_Server);
                Primech = cliPrm_f1.FindPrmValue(finder_f1, out ret);
                sw.WriteLine("Primech.val_prm = " + Primech.val_prm);
                if ((ret.result == true) & (Primech != null))
                {
                    rep.SetParameterValue("privat", Primech.val_prm);
                }
            ...
            try
            {
                ...
                if ((ret.result == true) & (Primech != null))
                {
                    if (Primech.val_prm == "да")
                        rep.SetParameterValue("privat", "Приватизированна");
                    else
                        rep.SetParameterValue("privat", "Не приватизированна");
                }
            ...
            try
            {
                #region ДатаПриватизации
                string sql = "SELECT ds.vid_dat_sv as vid_dat_sv " +
                            "FROM bill01_data.kart k " +
                            "INNER JOIN  bill01_data.sobstw s on s.nzp_gil = k.nzp_gil " +
                            "INNER JOIN bill01_data.doc_sobstw ds on ds.nzp_sobstw = s.nzp_sobstw " +
                            "WHERE s.nzp_kvar = " + CurT_nzp_kvar + " AND k.nzp_kart = " + CurT_nzp_Kart;
                sw.WriteLine(sql);
                string connectionString = Points.GetConnByPref(finder.pref);
                sw.WriteLine(Constants.cons_Webdata);
                sw.WriteLine(CurT_nzp_Kart);
                IDbConnection _connDb = DBManager.GetConnection(Constants.cons_Webdata);
                ret = DBManager.OpenDb(_connDb, true);
                if (!ret.result)
                    sw.WriteLine("Primech.val_prm = нет конекта");
                else
                    sw.WriteLine("Primech.val_prm = конект есть");

                IDataReader reader2;
                ret = DBManager.ExecRead(_connDb, out reader2, sql, true);
                if (!ret.result)
                {
                    rep.SetParameterValue("date_priv", "");
                }
                else
                {
                    while (reader2.Read())
                    {
                        sw.WriteLine("Primech.val_prm = " + Convert.ToString(reader2["vid_dat_sv"]));
                        rep.SetParameterValue("date_priv", Convert.ToDateTime(reader2["vid_dat_sv"]).ToShortDateString());
                    }
                }
                #endregion
            }
            ...
            {
                #region Комфортность
                Prm finder_f11 = new Prm();
                finder_f11.nzp_user = nzp_user;//web_user.nzp_user;
                finder_f11.nzp_kvar = CurT_nzp_kvar;
                finder_f11.nzp = CurT_nzp_kvar;
                finder_f11.pref = CurT_pref;
                finder_f11.prm_num = 1;
                finder_f11.rows = 10;
                finder_f11.month_ = m_;
                finder_f11.year_ = y_;
                finder_f11.nzp_prm = 3;

                ret = Utils.InitReturns();
                cli_Prm cliPrm_f11 = new cli_Prm(WCFParams.AdresWcfWeb.CurT_Server);
                Primech = cliPrm_f11.FindPrmValue(finder_f11, out ret);
                sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                if ((ret.result == true) & (Primech != null))
                {
                    if (Primech.val_prm == "изолированная")
                    {
                        sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                        rep.SetParameterValue("komf", "нет");
                    }
                    else if (Primech.val_prm == "коммунальная")
                    {
                        sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                        rep.SetParameterValue("komf", "да");
                    }
                    else
                    {
                        sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                        rep.SetParameterValue("komf", "не указано");
            ...
            try
            {
                ...
                Prm finder_f111 = new Prm();
                finder_f111.nzp_user = nzp_user;//web_user.nzp_user;
                finder_f111.nzp_kvar = CurT_nzp_kvar;
                finder_f111.nzp = CurT_nzp_kvar;
                finder_f111.pref = CurT_pref;
                finder_f111.prm_num = 1;
                finder_f111.rows = 10;
                finder_f111.month_ = m_;
                finder_f111.year_ = y_;
                finder_f111.nzp_prm = 107;

                ret = Utils.InitReturns();
                cli_Prm cliPrm_f111 = new cli_Prm(WCFParams.AdresWcfWeb.CurT_Server);
                Primech = cliPrm_f111.FindPrmValue(finder_f111, out ret);
                sw.WriteLine("Primech.val_prm = " + Primech.val_prm);
                if ((ret.result == true) & (Primech != null))
                {
                    rep.SetParameterValue("kol_kom", Primech.val_prm);
                }
            ...
            try
            {
                ...
                {
                    sw.WriteLine("SpisPrm.Count22 = " + SpisPrm.Count.ToString());
                    for (int i = 0; i < SpisPrm.Count; i++)
                    {
                        sw.WriteLine(SpisPrm[i].nzp_prm);
                        #region Разбираем параметры
            ...
            try
            {
                ...
                {
                    sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                    rep.SetParameterValue("pl_all", Primech.val_prm);
                }
                #endregion
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                {
                    sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                    rep.SetParameterValue("pl_gil", Primech.val_prm);
                }
                #endregion
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                {
                    sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                    rep.SetParameterValue("fact_gil", Primech.val_prm);
                }
                #endregion
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                {
                    sw.WriteLine("Primech.val_prm33 = " + Primech.val_prm);
                    rep.SetParameterValue("kolgil", Primech.val_prm);
                }
                #endregion
            }
            catch (Exception ex)
        ...
        public string Fill_licShet(Report rep, int y_, int m_, DateTime date, out Returns ret) {
            ...
            string connectionString = Points.GetConnByPref(finder.pref);
            IDbConnection conn_db = DBManager.GetConnection(connectionString);
            IDataReader reader;
            ...
            DBManager.ExecSQL(conn_db, "drop table t_svod", true);
            DBManager.ExecSQL(conn_db, "create temp table t_svod (peni NUMERIC(14,2) default 0)", true);

            DBManager.ExecSQL(conn_db, "insert into t_svod select sum(sum_insaldo) from bill01_charge_" + y1.ToString("00") + ".charge_" + m_.ToString("00") + " where nzp_serv = 500 and nzp_kvar = " + finder.nzp_kvar, true);

            sql1.Remove(0, sql1.Length);
            sql1.Append("SELECT sum(peni) as peni from t_svod");

            if (!DBManager.ExecRead(conn_db, out reader, sql1.ToString(), true).result)
            {
            ...
            else
            {
                if (reader.Read())
                {
                    if (reader["peni"] != DBNull.Value)
                        if (reader["peni"].ToString().Trim() != "")
                            sum_peni = reader["peni"].ToString().Trim();
                }
            }
            reader.Close();
                        ...
                        if (i < 16 && Lst[i].service != "ОДН")
                        {
                                ...
                                Lst[i].c_sn > 0.0001m)
                            {
                                ...
                                if (Lst[i].nzp_serv != -515)
                                {
                                    ...
                                    if (Lst[i].tarif < 0.001m && Lst[i].service != "Пени")
                                    {
                                        dr["tarif" + stIndex] = "";
                                        dr["c_calc" + stIndex] = "";
                                    }
                                ...
                                {
                                    decimal odn = 0;
                                    if (Lst[i].service.Substring(0, 4) == "Соде")
                                    {
                                        for (int j = 0; j < Lst.Count; j++)
                                        {
                                            if (j < 16 && Lst[j].service == "ОДН")
                                            {
                                                odn = Lst[j].sum_tarif;
                                            }
                                        }
                                    ...
                                    dr["sum_charge" + stIndex] = (Lst[i].sum_charge + odn).ToString("0.00");
                                }
                                stIndex++;
                            }
                        }
            ...
            rep.SetParameterValue("nachal_fio",
                listPrms.Find(x => x.nzp_prm == 1047) != null
                    ? "Грецова И.Н."//listPrms.Find(x => x.nzp_prm == 1047).val_prm
                    : string.Empty);
            ...
            //StreamWriter sw = new StreamWriter(@"C:/temp/dr6666666.txt", false);
            //sw.WriteLine("wwwwwww");
            //sw.WriteLine(rep.GetParameterValue("komf").ToString().Replace("отдельная", "изолированная"));
            ...
            dr["komf"] = rep.GetParameterValue("komf").ToString();
