...
{
    public class ReportPU004016 : BaseSqlReport
    {
        public override string Name
        {
            get { return "Базовый - Сведения о расходах по квартирным приборам учета (4.16)"; }
        }
        ...
        {
            get { return Resources.Report4_16; }
        }
        ...
        public override DataSet GetData()
        {
            ...
            foreach (string curPref in prefList)
            {
                ...
                sql = "insert into t_couns (nzp_kvar, nzp_serv, nzp_counter, num_cnt, name_type, cnt_stage, mmnog, measure,  " +
                    ...
                    " 0 , max(a.dat_uchet) as dat_uchet " +
                    " From " +
                    ...
                    " and a.dat_uchet between " + STCLINE.KP50.Global.Utils.EStrNull(DatUchet.AddDays(1).ToShortDateString()) +
                    " and " + STCLINE.KP50.Global.Utils.EStrNull(DatUchetPo.AddMonths(1).ToShortDateString()) +
                ...
                sql = " Select g.geu, u.ulica, d.idom, d.ndom, d.nkor, k.ikvar, k.nkvar, " +
                      "       k.nkvar_n, u.nzp_ul, d.nzp_dom, cs.nzp_counter, k.num_ls" +
