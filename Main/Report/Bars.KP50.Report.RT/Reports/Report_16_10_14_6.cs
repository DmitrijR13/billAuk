...
{
    class Report16101416 : BaseSqlReport
    {
        public override string Name
        {
            get { return "16.10.14.6 Сальдовая оборотная ведомасть в разрезе поставщиков, арендаторы"; }
        }

        public override string Description
        {
            get { return "10.14.6 Сальдовая оборотная ведомасть начислений и оплат по услугам в разрезе поставщиков, арендаторы"; }
        }
        ...
        {
            get { return Resources.Report_16_10_14_6; }
        }
        ...
        public override DataSet GetData()
        {
            ...
            sql = " SELECT area," +
                  ...
                  " FROM t_sald_obor_vedom_all a " +
                       ...
                       " LEFT OUTER JOIN " + ReportParams.Pref + DBManager.sKernelAliasRest + "supplier s  ON (a.nzp_serv=s.nzp_serv)" +
