...
{
    class Report16388 : BaseSqlReport
    {
        ...
        protected int ServicesOdn { get; set; }
        ...
        public override DataSet GetData()
        {
            ...
            while (reader.Read())
            {
                ...
                sql = " insert into t_svod select u.ulica, d.idom, d.nkor, "+
                        ...
                        " sum(case when nzp_serv = "+ServicesOdn+" then rsum_tarif else 0 end) r_odn, "+
                        " sum(case when nzp_serv = "+ServicesOdn+" then c_calc else 0 end) n_odn "+
                        ...
                        " and c.num_ls = k.num_ls and k.num_ls >0 and nzp_serv in ("+Services+", "+ServicesOdn+") "+
            ...
            DataTable dt = ExecSQLToTable(" select ulica, idom, case when nkor<>'-' then nkor end as nkor, " +
                DBManager.sNvlWord + "(pl" + DBManager.sConvToNum + ",0) as pl, r_pu, n_pu, r, n, r_odn, n_odn from t_svod1 order by 1,2");
