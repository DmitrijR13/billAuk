...
namespace Bars.KP50.Report.Samara.Reports
{
    ...
    class ReportPeniCheck : BaseSqlReport
    {
        ...
        {
            get { return Resources.ReportPeniCheck; }
        }
...
order by 1,2";
            ...
            decimal dolg_peni = Convert.ToDecimal(dt.Rows[dt.Rows.Count - 1][5]);
