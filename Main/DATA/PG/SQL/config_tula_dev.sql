...
insert into config(nzp_role) values (29);
...
insert into config(nzp_role) values (982); -- должники - настройки
...
insert into config(nzp_role) values (998); -- Очистка локального банка
...
insert into config(nzp_role) values (812); -- Просмотр статистики по начислениям
