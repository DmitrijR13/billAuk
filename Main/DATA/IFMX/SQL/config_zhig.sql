...
insert into config(nzp_role) values (978); -- Банк клиент настройка
insert into config(nzp_role) values (979); -- Банк клиент
insert into config(nzp_role) values (980); -- Управление ключами
insert into config(nzp_role) values (984); -- Быстрый ввод показаний ПУ
