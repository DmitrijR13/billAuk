...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table pages add up_kod integer;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table pages add group_id integer;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
...
--шифрование страниц
update pages set page_url = encrypt_aes(page_url), page_menu = encrypt_aes(page_menu), page_name = encrypt_aes(page_name), hlp = encrypt_aes(hlp) where 1=1;
...
--шифрование действий
update s_actions set act_name = encrypt_aes(act_name), hlp = encrypt_aes(hlp) where 1=1; 
...
CREATE PROCEDURE tshu_drp()
  on exception return; 
        ...
        GRANT select, update, insert, delete, index ON report TO public AS webdb;
...
--!175
insert into pages_show (cur_page,page_url,up_kod,sort_kod)
select 175,nzp_page,0,nzp_page from pages
where nzp_page in (30,31,32,33,34,35,37,38,195, 40,41,42,50,53,56, 73,44,45,168,170,210,221,224,256,257,261, 72,81,82,106,107,340)
   or nzp_page >= 950 
   or nzp_page <  10;
...
insert into pages_show (cur_page,page_url,up_kod,sort_kod) 
select a.nzp_page, b.nzp_page, nvl(b.up_kod,0), b.nzp_page 
...
insert into pages_show (cur_page,page_url,up_kod,sort_kod)
select distinct a.cur_page, b.nzp_page, nvl(b.up_kod,0), b.nzp_page 
...
insert into pages_show (cur_page,page_url,up_kod,sort_kod)
select distinct a.nzp_page, b.nzp_page, nvl(b.up_kod,0), b.nzp_page
...
create temp table ps (cur_page integer, up_kod integer) with no log;
...
begin
        ...
        foreach select unique cur_page into i from actions_show where nzp_act > 200 and nzp_act < 500
          let j = 0;
          foreach select nzp_ash, decrypt_char(b.act_name) into k, act from actions_show a, s_actions b where a.nzp_act > 200 and a.nzp_act < 500 and a.nzp_act = b.nzp_act and a.cur_page = i order by 2
            let j = j + 1;
            update actions_show set sort_kod = j where nzp_ash = k;  
          end foreach
        end foreach
end
END PROCEDURE;
...
update s_roles set role = encrypt_aes(role) 
...
insert into t_role_merging (nzp_role_from, nzp_role_to) select a.nzp_role, b.nzp_role from s_roles a, s_roles b where b.nzp_role = 901 and a.nzp_role in (927,928,948,963,965);
...
insert into t_role_merging (nzp_role_from, nzp_role_to) select a.nzp_role, b.nzp_role from s_roles a, s_roles b where b.nzp_role = 942 and a.nzp_role in (803);
...
and r.nzp_page in (35,36,44,49,112,126,133,134,137,166,167,168,192,206,227,228,296,338);
...
where b.nzp_role = 922 and r.nzp_role = 10
and (
        (r.nzp_page in (35,36,44,49,126,166,167,192,227,228,296,338) and r.nzp_act not in (124)) or
        (r.nzp_page in (133,134,137,206) and r.nzp_act in (69,610)) or
		nzp_act in (206,228,230,231,232,233,234,235,236,239,240,247,248,250,251,253,254,255,259,260,261,269,270,271,272,294,299,300,302,306,309,310,320,326,327,342)
)
...
and r.nzp_page in (35,36,37,44,49,112,126,133,134,137,166,167,168,192,206,296,66,67,92,93,185,186,187,227,228);
...
where b.nzp_role = 961 and r.nzp_role = 10
and (
        (r.nzp_page in (35,36,37,44,49,126,166,167,192,296,66,67,92,93,185,186,187,227,228) and r.nzp_act not in (124)) or
        (r.nzp_page in (133,134,137,206) and r.nzp_act in (69,610)) or
...
and r.nzp_page in (35,36,37,44,112,124,126,133,134,137,66,67,92,93,185,186,187,206,227,228,296);
...
where b.nzp_role = 924 and r.nzp_role = 10
and (
        r.nzp_page in (35,36,37,44,49,112,124,126,66,67,92,93,185,186,187,227,228,296) or
        (r.nzp_page in (133,134,137,206) and r.nzp_act in (69,610)) or
...
and r.nzp_page in (35,36,44,49,112,126,134,137,166,167,192,206,227,228,296);
...
where b.nzp_role = 953 and r.nzp_role = 10
and (
	r.nzp_page in (35,36,44,49,166,167,192,227,228,296) or
...
and r.nzp_page in (35,36,37,44,49,112,124,126,134,206,166,167,66,67,92,93,185,186,187,227,228);
...
where b.nzp_role = 926 and r.nzp_role = 10
and (
        r.nzp_page in (35,36,44,49,37,112,124,126,166,167,206,66,67,92,93,185,186,187,227,228) or
        r.nzp_act in (507) or
...
and r.nzp_page in (35,36,44,112,126,133,134,137,166,167,168,192,206,227,228);
...
where b.nzp_role = 947 and r.nzp_role = 10
and (
        (r.nzp_page in (35,36,44,112,126,166,167,168,192,227,228)) or
        (r.nzp_page in (133,134,137,206)  and r.nzp_act in (69,610)) or
...
and r.nzp_page in (35,36,44,49,112,126,134,137,166,167,192,206,227,228,296,337);
...
and nzp_page in (35,36,37,44,49,66,67,92,93,112,124,126,133,134,137,166,167,185,186,187,192,206,227,228,296,337,338);

delete from role_actions where nzp_role = 10
and (
        nzp_page in (35,36,37,44,49,66,67,92,93,112,124,126,133,134,137,166,167,185,186,187,192,206,227,228,296,337,338) or
        nzp_act in (175,507)
);
...
where b.nzp_role = 927 and r.nzp_role = 901
and (
        (r.nzp_page in (44,166,167,168,227,228,243,295,296)) or
        (nzp_act = 112) or
...
where b.nzp_role = 963 and r.nzp_role = 901
and (
        (r.nzp_page in (37,44,166,167,168,227,228,243,295,296)) or
        (nzp_act = 112) or
        (r.nzp_page = 41 and nzp_act = 172)
);
...
where b.nzp_role = 928 and r.nzp_role = 901
and (
        r.nzp_page in (37,44,166,167,168,227,228,296)
);
...
where b.nzp_role = 948 and r.nzp_role = 901
and (
        (r.nzp_page in (44,166,167,168,227,228,243)) or
        (nzp_act = 112)
);
...
select nzp_role, cur_page, nzp_act,'',cast(null as integer)
from actions_show a, s_roles b
where a.cur_page in (200,201,202,203,204,232,253,257,258,265,304,311,312,340
,269 -- в разработке
)
...
and a.nzp_act in (4,26,61,108,170,611)
and b.nzp_role = 806;
...
delete from role_pages where nzp_role not in (select nzp_role from config where decrypt_char(sign) = nzp_role||'-'||nzp_config||'config');
delete from role_actions where nzp_role not in (select nzp_role from config where decrypt_char(sign) = nzp_role||'-'||nzp_config||'config');
delete from roleskey where nzp_role < 1000 and nzp_role not in (select nzp_role from config where decrypt_char(sign) = nzp_role||'-'||nzp_config||'config');
delete from roleskey where tip = 105 and kod < 1000 and kod not in (select nzp_role from config where decrypt_char(sign) = nzp_role||'-'||nzp_config||'config');
delete from s_roles where nzp_role < 1000 and nzp_role not in (select nzp_role from config where decrypt_char(sign) = nzp_role||'-'||nzp_config||'config');
...
--Шифрование данных
update pages_show set sign = encrypt_aes(sort_kod||up_kod||page_url||cur_page||'-'||nzp_psh||'pages_show') where 1=1;
update actions_show set sign = encrypt_aes(sort_kod||act_dd||act_tip||nzp_act||cur_page||'-'||nzp_ash||'actions_show') where 1=1;

update roleskey set sign = encrypt_aes(tip||kod||nzp_role||'-'||nzp_rlsv||'roles') 
where (nzp_role >= 10 and nzp_role < 1000) or (tip = 105 and kod >= 10 and kod < 1000);

update role_pages set sign = encrypt_aes(nzp_role||nzp_page||'-'||id||'role_pages') 
where nzp_role >= 10 and nzp_role < 1000;

update role_actions set sign = encrypt_aes(nzp_role||nzp_page||nzp_act||'-'||id||'role_actions') 
where nzp_role >= 10 and nzp_role < 1000;
...
update statistics for table log_access;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
    create index ix_srlc_2 on s_roles (nzp_role,  page_url);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

update statistics for table s_roles;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
    alter table users add date_begin date;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

------------------Таблица для Excel отчетов---------------------------------------------
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table   excel_utility add dat_today date;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        create table excel_utility
        ( nzp_exc      serial not null,
          ...
          dat_in       datetime year to second,        --дата начала выгрузки
          dat_start    datetime year to second,        --дата начала обработки выгрузки
          dat_out      datetime year to second,        --дата окончания выгрузки
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        (
            nzp_up SERIAL PRIMARY KEY,
                dateup DATETIME YEAR TO SECOND,
                typeUp CHAR(50),
        ...
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','web','0' , 1,'Запись по умолчанию');
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','host','0' , 1, 'Запись по умолчанию');
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ALTER TABLE updater ADD dateup DATETIME YEAR TO SECOND BEFORE typeup;
        UPDATE  updater SET dateup = '1900-01-01 00:00:00' WHERE dateup IS NULL;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;


CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','broker','0' , 1,'Запись по умолчанию');
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','script','0' , 1,'Запись по умолчанию');
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','updhost','0' , 1,'Запись по умолчанию');
        INSERT INTO updater (dateup,typeUp,version, status, path) values ('1990-01-01 00:00:00','updbroker','0' , 1,'Запись по умолчанию');
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
------------------------------------------------------------------------------------------
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        CREATE UNIQUE INDEX "webdb".ix_users_links_1 ON "webdb".users_links(nzp_user_link);
        CREATE INDEX "webdb".ix_users_links_2 ON "webdb".users_links(nzp_user);
        GRANT select, update, insert, delete, index ON users_links TO public AS webdb;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table users add is_remote integer default 0;
        update users set is_remote = 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
...
CREATE TABLE "webdb".pack(
   nzp_pack SERIAL NOT NULL,
...
create unique index "webdb".ix_pack_1 ON "webdb".pack(nzp_pack);
create unique index "webdb".ix_pack_2 ON "webdb".pack(nzp_bank, num_pack);

CREATE TABLE "webdb".pack_ls(
   nzp_pack_ls SERIAL NOT NULL,
   nzp_pack INTEGER not null,
...
create unique index "webdb".ix_pack_ls_1 ON "webdb".pack_ls(nzp_pack_ls);
create unique index "webdb".ix_pack_ls_2 ON "webdb".pack_ls(nzp_pack, info_num);
alter table "webdb".pack_ls add constraint (foreign key (nzp_pack) references "webdb".pack(nzp_pack) constraint "webdb".fk_pack_ls_1);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;


set indexes for pack_ls disabled;
set indexes for pack_ls enabled;

update statistics;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 

        Create table "webdb".bill_fon (
        ...
        Create unique index "webdb".ix_bill_fon_1 on bill_fon (nzp_key);
        Create        index "webdb".ix_bill_fon_2 on bill_fon (nzp_key,year_,month_,kod_info);
        Create        index "webdb".ix_bill_fon_3 on bill_fon (nzp_user,kod_info);
        --Create        index "webdb".ix_bill_fon_4 on bill_fon (prior);

        alter table "webdb".bill_fon lock mode (row);

END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table bill_fon add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table users add nzp_payer integer;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table users add appointment char(200);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table users add nzp_bank integer;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        CREATE UNIQUE INDEX "webdb".ix_sfon_1 ON "webdb".saldo_fon(nzp_key);
        CREATE        INDEX "webdb".ix_sfon_2 ON "webdb".saldo_fon(nzp_area, year_, month_, kod_info);
        CREATE        INDEX "webdb".ix_sfon_3 ON "webdb".saldo_fon(kod_info);

        alter table "webdb".saldo_fon lock mode (row);
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        alter table webdb.s_setups add param_type char(50);

        update s_setups set param_type = 'char';
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        insert into s_setups (nzp_setup, nzp_param, param_name, param_type, value_, nzp_user, dat_when) 
        values (0, 7, 'Работать только с центральным банком данных', 'bool', '2', null, null);
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        ...
        create table webdb.user_processes
        ( nzp_key serial not null,
            nzp_user integer,
            table_name char(250),
            procId char(250)
        ...
        create unique index webdb.ix_user_processes_1 on webdb.user_processes(nzp_key);       
        create unique index webdb.ix_user_processes_3 on webdb.user_processes(procId);

END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
           
        drop index ix_user_processes_2;

END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table log_sessions add session_id char(32), add left_on datetime year to second;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table s_roles add is_active integer default 1;
	update s_roles set is_active = 1;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        create table webdb.s_accesskod
		(
			nzp_acc serial not null,
			name 		   char(250)
		);
		
		insert into webdb.s_accesskod(nzp_acc,name) values(1,'Аутентификация прошла успешно');
		insert into webdb.s_accesskod(nzp_acc,name) values(2,'Выход из системы');
		insert into webdb.s_accesskod(nzp_acc,name) values(3,'Несанкционированный доступ');
		
		create unique index webdb.ix_s_accesskod_1 on webdb.s_accesskod(nzp_acc); 
		
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table excel_utility add progress DECIMAL(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table excel_utility add is_shared integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_0 add nzp_user integer default 0;		
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_1 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_2 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_3 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_4 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_5 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_6 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_7 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_8 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_9 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_10 add nzp_user integer default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_0 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_1 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_2 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_3 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_4 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_5 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_6 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_7 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_8 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_9 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table  calc_fon_10 add parameters varchar(255);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_0   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_1   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_2   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_3   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_4   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_5   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_6   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_7   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_8   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_9   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
		alter table  calc_fon_10   modify    parameters char(2000);
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;


CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
	create table user_actions (id serial not null, nzp_user integer, nzp_page integer, page_name varchar(255), nzp_act integer, act_name varchar(255), changed_on datetime year to second);
...
CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table saldo_fon add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_0 add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_1 add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_2 add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;

CREATE PROCEDURE tshu_drp() on exception return; end exception with resume 
        alter table calc_fon_3 add progress decimal(6,4) default 0;
END PROCEDURE; EXECUTE PROCEDURE tshu_drp(); DROP PROCEDURE tshu_drp;
