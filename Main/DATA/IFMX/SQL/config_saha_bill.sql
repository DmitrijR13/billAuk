...
insert into config(nzp_role) values (901); -- Картотека (Редактирование)
insert into config(nzp_role) values (947); -- Картотека-Саха
insert into config(nzp_role) values (948); -- Картотека Саха (Редактирование)
...
insert into config(nzp_role) values (903); -- Приборы учета (Редактирование)
