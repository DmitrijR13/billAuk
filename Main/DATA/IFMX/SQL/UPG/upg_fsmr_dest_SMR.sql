...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (8,'Течь в водопроводных трубах',1,0,22,26);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (9,'Повреждения аварийные трубопроводов и их сопряжений',0,1,22,26);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (19,'Неисправности канализационной сети',1,0,22,26);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (23,'Отсутствие уборки в подъезде',1,0,18,24);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (24,'Отсутствие уборки двора',1,0,17,25);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (26,'Течь в системе отопления',1,0,21,27);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (30,'Неисправности в системе отопления',1,0,21,27);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (36,'Неисправности водопроводной сети',0,0,22,26);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (42,'Неудовлетворительное содержание двора',0,0,17,25);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (49,'Течь в канализационной сети',0,0,22,26);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (50,'Неудовлетворительная уборка подъезда',0,0,18,24);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (65,'Отсутствие отопления в подъездах',0,0,21,27);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (74,'Неисправности смывного бачка',0,0,22,26);
...
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (76,'Течь в водопроводных трубах (в подвальных помещениях)',0,0,22,26);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (77,'Течь в канализационной сети (в подвальных помещениях)',0,0,22,26);
insert into "are".s_dest ( nzp_dest, dest_name, term_days, term_hours, nzp_serv, num_nedop) values (78,'Течь в системе отопления (в подвальных помещениях)',0,0,21,27);
