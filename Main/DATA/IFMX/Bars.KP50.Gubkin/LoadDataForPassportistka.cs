    ...
    public class DBLoadDataForPassportistka : DbAdminClient
    {
        ...
        public Returns Run(FilesImported finder)
        {
            ...
            try
            {
                ...
                //имя файла
                string fileName = Path.Combine(fDirectory, System.IO.Path.GetFileNameWithoutExtension(finder.saved_name));
...
" VALUES (0)";
            ...
            {
                MonitorLog.WriteLog(
                    "Ошибка выполнения процедуры Run : " + ex.Message + ex.StackTrace,
