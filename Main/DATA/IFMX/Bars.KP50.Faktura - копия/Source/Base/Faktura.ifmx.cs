...
namespace Bars.KP50.DB.Faktura
{
    ...
    public class SumServ : ICloneable
    {
        ...
        public void AddSum(SumServ aServ, Boolean isPeni = true)
        {
            ...
            //else
            //{
            //    StreamWriter streamWriter = new StreamWriter("C:\\temp\\FillMainChargeGridPeni.txt", true);
            //    streamWriter.WriteLine(aServ.Reval);
            //    streamWriter.WriteLine(aServ.RealCharge);
            //    streamWriter.Close();
            //}
            SumPere += aServ.SumPere;        
            SumCharge += aServ.SumCharge;
            SumMoney += aServ.SumMoney;
            MoneyTo += aServ.MoneyTo;
            Norma += aServ.Norma;
...
#warning Костыль
        ...
        protected virtual bool FillSummuryBill(DataRow dr)
        {
            ...
            StreamWriter sw = new StreamWriter(@"C:\temp\people1111.txt", false);
            sw.WriteLine(SummaryServ.Serv.MoneyTo);
            sw.Close();
