...
namespace STCLINE.KP50.Interfaces
{
    ...
    public interface I_Counter
    {
        ...
        [OperationContract]
        List<CounterCnttypeLight> LoadCntType(Counter finder, out Returns ret);
        ...
        /// <returns></returns>
        [OperationContract]
        List<ReplacedCounter> LoadPuForReplacing(Counter finder, out Returns ret);
        ...
        [OperationContract]
        Returns CalcForPU(Ls finder, int p_year, int p_month);
        ...
        [OperationContract]
        List<Ls> LoadForFastPu(Ls finder, enSrvOper oper, out Returns ret);
        //#warning функции, работающие с counters, counters_dom, counters_group через counters_vals. Не использовать
        //        [OperationContract]
        //        List<CounterVal> GetPuData(Ls finder, out Returns ret);

        //        [OperationContract]
        //#warning функции, работающие с counters, counters_dom, counters_group через counters_vals. Не использовать
        //        Returns CopyCounterReadingToRealBank(List<CounterVal> finder);

        //        [OperationContract]
        //#warning функции, работающие с counters, counters_dom, counters_group через counters_vals. Не использовать
        //        Returns PrintCounterValBlank(CounterVal finder);

        // новые
        [OperationContract]
        Returns CopyCounterValueToRealBank(List<CounterValLight> finder);
        [OperationContract]
        Returns SaveCounterListVals(List<CounterValLight> newVals);
        [OperationContract]
        Returns SaveCountersValsLight(List<CounterValLight> newVals);
        [OperationContract]
        List<CounterValLight> GetCountersUserVals(CounterValLight finder, out Returns ret);
        [OperationContract]
        List<CounterReading> GetLsPuData(Ls finder, out Returns ret);
        [OperationContract]
        Returns PrintCounterValBlankLight(CounterValLight finder);
        [OperationContract]
        List<CounterReading> GetPuListVals(CounterValLight finder, enSrvOper oper, out Returns ret);
        [OperationContract]
        List<CounterValLight> GetCountersValsForEdit(CounterValLight finder, out Returns ret);
        [OperationContract]
        List<CounterValLight> GetCountersValsForView(CounterValLight finder, out Returns ret);
        [OperationContract]
        Returns DeleteCounterVal(CounterValLight val);
        [OperationContract]
        Returns GetRashodIPU(Counter finder, out string rashod_k_opl);
        [OperationContract]
        List<CounterBounds> GetCounterBoundses(CounterBounds finder, out Returns ret);
        [OperationContract]
        Returns SaveCounterBounds(CounterBounds finder);
        }

    public interface ICounterRemoteObject : I_Counter, IDisposable
    {
    ...
    public class Counter : Ls
    {
        ...
        [DataMember]
        public string rashod_without_koef { get; set; }  //расход с учетом коэффициента

        [DataMember]
        public string rashod_k_opl { get; set; }  //расход к оплате
        ...
        /// <summary>
        /// Код ПУ, являющийся корневым в связке заменных ПУ
        /// </summary>
        [DataMember]
        public int nzp_counter_old { get; set; }

        /// <summary>
        /// Непосредственно предыдущий ПУ, замененный текущим ПУ
        /// </summary>
        [DataMember]
        public int nzp_counter_replaced { get; set; }

        /// <summary>
        /// инфо по предыдущему ПУ, заменном текущим ПУ: номер счетчика и дата закрытия
        /// </summary>
        [DataMember]
        public string counter_replaced_info { get; set; }
        ...
        public double GetMaxValue
        {
            get
            {
                if (max_rashod > 0) return max_rashod;
                else return Math.Pow(10, cnt_stage) * Convert.ToDouble(mmnog) * 0.5; // половина диапазона значений
            }
        ...
        [DataMember]
        public bool IsBigRashod
        {
            get
            {
                return this.calculatedRashod > this.GetMaxValue;
            }
        ...
        [DataMember]
        public double max_rashod { get; set; }
            ...
            : base()
        {
            ...
            nzp_counter_old = 0;
            nzp_counter_replaced = 0;
            counter_replaced_info = "";
        }
    }

    public class CounterValLight : Finder, IDisposable
    {
        //----------------------------------------------------
        string _nkvar;
        string _nkor;
        ...
        public string val_cnt_s { get; set; }
        [DataMember]
        public string val_cnt_old { get; set; }
        [DataMember]
        public decimal val_cnt_pred { get; set; }
        [DataMember]
        public string val_cnt_pred_s { get; set; }
        ...
        public decimal ngp_lift { get; set; }
        [DataMember]
        public string ngp_lift_old { get; set; }
        [DataMember]
        public string ngp_cnt_s { get; set; }
        [DataMember]
        public decimal ngp_cnt { get; set; }
        [DataMember]
        public string ngp_cnt_old { get; set; }
        [DataMember]
        ...
        public string dat_uchet { get { return Utils.ENull(_dat_uchet); } set { _dat_uchet = value; } } //дата показания
        [DataMember]
        public string dat_uchet_old { get; set; }
        [DataMember]
        public string dat_provnext { get { return Utils.ENull(_dat_provnext); } set { _dat_provnext = value; } }
        [DataMember]
        public string dat_prov { get { return Utils.ENull(_dat_prov); } set { _dat_prov = value; } }
        ...
        /// <summary>
        /// Сохранить весь расход в текущем расчетном месяце
        /// </summary>
        [DataMember]
        public int isSaveRashodInCurPeriod { get; set; }
        ...
        public int is_actual { get; set; }
        [DataMember]
        public int nzp_user_web { get; set; }
        /// <summary>
        /// Результат сохранения показания
        /// </summary>
        [DataMember]
        public string upload_result { get; set; }

        public CounterValLight()
            : base()
        {
            nzp_counter = 0;
            nzp_key = 0;
            isSaveRashodInCurPeriod = 0;
            dat_month = "";
            ist = 0;
            ist_old = 0;
            ist_name = "";
    ...
    [DataContract]
    public class CounterVal : Counter, IDisposable
    {
        /// <summary>
        ...
        public enum Ist
        {
            ...
            /// <summary>
            /// Введено оператором КП 2.0
            /// </summary>
            Operator20 = 0,

            /// <summary>
            /// Передано через порталгос. услуг
            /// </summary>
            Portal = 1,

            /// <summary>
            /// Передано из диспетчерской службы
            /// </summary>
            SUPG = 2,
            ...
            /// <summary>
            /// Введено оператором вручную
            /// </summary>
            Operator = 9,

            /// <summary>
            /// показание загружено из Самарского DBF файла с портала
            /// </summary>
            FileSamara = 11,

            /// <summary>
            /// Показания приборов учета, переданных ввместе с оплатой от банка
            /// </summary>
            Bank = 12,

            /// <summary>
            /// Показание введено жильцом через портал
            /// </summary>
            Gilec = 175
        }
        ...
        {
            if (id == (int)Ist.FileSamara) return Ist.FileSamara;
            else if (id == (int)Ist.Portal) return Ist.Portal;
        ...
        [DataMember]
        public int nzp_cg { get; set; }
        [DataMember]
        public int nzp_cr { get; set; }
        [DataMember]
        public int nzp_crd { get; set; }
    ...
    [DataContract]
    public class CounterCnttypeLight
    {
        [DataMember]
        public int nzp_cnttype { get; set; }
    ...
    [DataContract]
    public class ReplacedCounter
    {
        /// <summary>
        /// Корневой код ПУ, связывающий закрытые ПУ в единую цепочку
        /// </summary>
        [DataMember]
        public int nzp_counter_old { get; set; }
        /// <summary>
        ...
        public int nzp_counter_replaced { get; set; }
        /// <summary>
        /// номер ПУ закрытого ПУ + Дата закрытия ПУ
        /// </summary>
        [DataMember]
        public string pu_replaced_info { get; set; }

        public ReplacedCounter()
        {
            nzp_counter_old = 0;
            nzp_counter_replaced = 0;
            pu_replaced_info = "";
    ...
    /// <summary>
    /// Периоды работоспособности, неработоспособности для счетчиков
    /// </summary>
    public class CounterBounds : Finder
    {
        [DataMember]
        private DateTime date_from_bf;
        [DataMember]
        private DateTime date_to_bf;
        [DataMember]
        ...
        {
            get { return date_from_bf; }
            set
            {
                date_from_bf = value == DateTime.MinValue ? new DateTime(1900, 1, 1) : value;
            }
        }
        [DataMember]
        public DateTime date_to
        {
            get { return date_to_bf; }
            set
            {
                date_to_bf = value == DateTime.MinValue ? new DateTime(3000, 1, 1) : value;
            }
        }
        [DataMember]
        ...
        [DataMember]
        private string s_changed_on_bf;
        [DataMember]
        private string s_created_on_bf;
        [DataMember]
        public string s_created_on
        {

            get { return s_created_on_bf; }
            set
            {
                if (value != DateTime.MinValue.ToShortDateString())
                {
                    s_created_on_bf = value;
                }
            }
        }
        [DataMember]
        public string s_changed_on
        {

            get { return s_changed_on_bf; }
            set
            {
                if (value != DateTime.MinValue.ToShortDateString())
                {
                    s_changed_on_bf = value;
                }
            }
        }
        [DataMember]
    ...
    /// <summary>
    /// для генерации ИПУ через групповые операции: услуга + список видов помещений
    /// </summary>
    [Serializable]
    public struct puRooms
    {
        public int nzp_serv;
        public List<PrmTypes> roomList;
    }
