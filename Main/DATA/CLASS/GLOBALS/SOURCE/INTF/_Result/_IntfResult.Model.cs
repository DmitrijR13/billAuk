...
namespace STCLINE.KP50.Interfaces
{
    ...
    public class ReturnsObjectType<T> : ReturnsType where T : class, new()
    {
        ...
        public ReturnsObjectType(STCLINE.KP50.Global.Returns ret) : this(null, ret.result, ret.text, ret.tag) { }
        public ReturnsObjectType(T returnsData, STCLINE.KP50.Global.Returns ret) : this(returnsData, ret.result, ret.text, ret.tag) { }
