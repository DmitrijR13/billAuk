...
namespace STCLINE.KP50.Interfaces
{
    ...
    public interface I_FnReval
    {
        ...
        [OperationContract]
        List<FnReval> LoadFnRevalSupp(FnRevalFinder finder, out Returns ret);
        ...
        [OperationContract]
        Returns OperateWithFnRevalSupp(FnReval finder, FnReval.Operations oper);
    }
    ...
    public class FnReval : Finder
    {
        ...
        [DataMember]
        public int nzp_supp_2 { get; set; }
        [DataMember]
        public string supp_2 { get; set; }
