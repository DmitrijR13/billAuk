...
namespace STCLINE.KP50.Interfaces
{
    ...
    public interface I_MustCalc
    {
        ...
        [OperationContract]
        List<ProhibitedMustCalc> GetProhibitedMustCalc(ProhibitedMustCalc finder, out Returns ret);
        [OperationContract]
        void SaveProhibitedMustCalc(ProhibitedMustCalc finder, out Returns ret);
        [OperationContract]
        void DeleteProhibitedMustCalc(ProhibitedMustCalc finder, out Returns ret);

        [OperationContract]
        Returns SaveDisableMustCalcTXXspls(MustCalc finder, List<Service> services);

        [OperationContract]
        List<Service> LoadSuppliersForDisableMustCalcLs(Service finder, out Returns ret);

        [OperationContract]
        List<Service> LoadServiceForDisableMustCalcLs(Service finder, out Returns ret);
    }
    ...
    public class MustCalc : Finder
    {
        ...
        /// <summary>
        /// Запись периодов перерасчетов для связанных услуг
        /// </summary>
        [DataMember]
        public bool for_slave_serv { get; set; }
        public MustCalc()
            : base()
        {
            nzp_kvar = 0;
    ...
    public class ProhibitedMustCalc : Finder
    {
        [DataMember]
        public int nzp_kvar { get; set; }
        [DataMember]
        ...
        [DataMember]
        public int prohibited_id { get; set; }

        public ProhibitedMustCalc()
            : base()
        {
            prohibited_id = 0;
            nzp_kvar = 0;
