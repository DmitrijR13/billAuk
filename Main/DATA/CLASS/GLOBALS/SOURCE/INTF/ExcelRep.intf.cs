...
namespace STCLINE.KP50.Interfaces
{
    ...
    public interface I_ExcelRep
    {
        ...
        [OperationContract]
        Returns GetUploadReestr(Finder finder, List<int> BanksList, out Returns ret);
        ...
        [OperationContract]
        Returns GetUploadLsAdr(Finder finder, string list_towns);
        ...
        //напоминание
        [OperationContract]
        Returns GetReminderToDebitor(Deal finder, ReportType type);

        //уведомление
        [OperationContract]
        Returns GetNoticeToDebitor(Deal finder, ReportType type);

        //предупреждение
        [OperationContract]
        Returns GetWarningToDebitor(Deal finder, ReportType type);
