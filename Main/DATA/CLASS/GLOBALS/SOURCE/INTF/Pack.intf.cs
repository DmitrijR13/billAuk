...
{  
    ...
    public interface I_Pack
    {
        ...
        [OperationContract]
        Returns AddTag(int indexFormat);

        [OperationContract]
        Returns DeleteTag(int indexTag);

        [OperationContract]
        Returns SaveTag( _TagsBC tag);

        [OperationContract]
        Returns UpTag(_TagsBC finder);

        [OperationContract]
        Returns DownTag(_TagsBC finder);

        [OperationContract]
        List<CalcMethod> ListBcFields(Finder finder, out Returns ret);

        [OperationContract]
        List<CalcMethod> ListBcRowType(Finder finder, out Returns ret);
    ...
    public class OperDayFinder : Finder
    {
        ...
        public enum Mode
        {
            /// <summary> Закрыть операционный день
            /// </summary>
            CloseOperDay = 0,
