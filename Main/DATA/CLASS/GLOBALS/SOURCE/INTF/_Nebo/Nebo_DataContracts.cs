...
namespace STCLINE.KP50.Interfaces
{
    ...
    /// <summary>
    /// данные для реестра Небо
    /// </summary>
    [DataContract]
    public class NeboReestr
    {
        public NeboReestr()
            : base()
        {
        ...
        //контрольная сумма по sum_money
        [DataMember]
        public decimal kontr_sum_prih { get; set; }
    ...
    /// <summary>
    /// реестр сальдо по домам (кроме арендаторов)
    /// </summary>
    [DataContract(Namespace = Constants.Linespace, Name = "SaldoInfoType")]
    public class NeboSaldo
    {
        public NeboSaldo()
            : base()
        {
    ...
    /// <summary>
    /// реестр поступление - население
    /// </summary>
    [DataContract(Namespace = Constants.Linespace, Name = "ReestrInfoType")]
    public class NeboPaymentReestr
    {
        public NeboPaymentReestr()
            : base()
        {
            dat_uchet = "";
            pkod = 0;
        ...
        ///<summary>Дата учета</summary>
        [DataMember(Name = "dat_uchet", Order = 10)]
        public string dat_uchet { get; set; }

        ///<summary>Идентификатор лицевого счета</summary>
        [DataMember(Name = "pkod", Order = 20)]
        public decimal pkod { get; set; }

        ///<summary>Код дома</summary>
        [DataMember(Name = "nzp_dom", Order = 30)]
        public int nzp_dom { get; set; }

        ///<summary>Код услуги</summary>
        [DataMember(Name = "nzp_serv", Order = 40)]
        public int nzp_serv { get; set; }

        ///<summary>Код поставщика</summary>
        [DataMember(Name = "nzp_supp", Order = 50)]
        public int nzp_supp { get; set; }

        ///<summary>оплата</summary>
        [DataMember(Name = "sum_prih", Order = 60)]
        public decimal sum_prih { get; set; }
    }
}
