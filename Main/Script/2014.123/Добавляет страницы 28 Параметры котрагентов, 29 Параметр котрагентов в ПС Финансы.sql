...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (29, '~/kart/prm/prm.aspx', 'Параметр контрагента', 'Параметр контрагента', 'переходит на форму просмотра и редактирования выбранного параметра управляющей организации', null, null);

INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (355, 77, 4, 0, 0);
...
INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (355, 77, 28);
...
INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (15, 355, 77, null);
