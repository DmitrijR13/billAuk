...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (27, '~/kart/gil/otvetstv.aspx', 'Назначить ответственного', 'Назначить ответственного', 'переходит на форму назначения ответственного', null, null);

INSERT INTO s_actions (nzp_act, act_name, hlp) VALUES  (914, 'Назначить ответств-го', 'Переход на форму назначения ответственного');

INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (27, 552, 552, 0, 0);
INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (162, 914, 914, 0, 0);

INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (162, 914, 27);
INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (27, 552, 27);
...
INSERT INTO img_lnk (cur_page, tip, kod, img_url) VALUES  (0, 2, 914, 'send.png');

INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (14, 162, 914, null);
INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (14, 27, 552, null);

INSERT INTO role_pages (nzp_role, nzp_page) VALUES  (14, 27);
