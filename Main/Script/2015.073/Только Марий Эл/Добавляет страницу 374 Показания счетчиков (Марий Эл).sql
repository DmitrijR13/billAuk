...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (374, '~/kart/counter/workwithcountersreadings.aspx', 'Показания счетчиков', 'Показания счетчиков', 'позволяет выгрузить и загрузить показания счетчиков', 270, 270);
...
INSERT INTO s_roles (nzp_role, role, page_url, sort) VALUES  (10, 'Картотека', 0, 889);

INSERT INTO role_pages (nzp_role, nzp_page) VALUES  (10, 374);
