...
INSERT INTO s_actions (act_name, hlp, nzp_act) VALUES  ('40 Заявление о регистрации по месту жительства', '40 Заявление о регистрации по месту жительства', 938);

INSERT INTO actions_show (sort_kod, act_tip, act_dd, cur_page, nzp_act) VALUES  (8, 2, 5, 135, 938);
...
INSERT INTO role_actions (mod_act, nzp_role, nzp_page, nzp_act) VALUES  (null, 14, 135, 938);

INSERT INTO report (name, file_name, nzp_act) VALUES  ('40 Заявление о регистрации по месту жительства', 'Zay_reg_git_f6_obn.frx', 938);
