...
INSERT INTO s_actions (act_name, hlp, nzp_act) VALUES  ('40 Свидетельство о регистрации по месту жительства', '40 Свидетельство о регистрации по месту жительства', 939);

INSERT INTO actions_show (sort_kod, act_tip, act_dd, cur_page, nzp_act) VALUES  (15, 2, 5, 135, 939);
...
INSERT INTO role_actions (mod_act, nzp_role, nzp_page, nzp_act) VALUES  (null, 14, 135, 939);

INSERT INTO report (name, file_name, nzp_act) VALUES  ('40 Свидетельство о регистрации по месту жительства', 'svid_reg_git_reb_obn.frx', 939);
