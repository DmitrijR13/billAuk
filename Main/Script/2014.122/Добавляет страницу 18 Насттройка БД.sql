...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (18, '~/admin/settings/tuningdb.aspx', 'Настройка БД', 'Настройка БД', 'Позволяет задания, связяанные с настройкой БД, поставить в очередь', 270, 270);

INSERT INTO s_actions (nzp_act, act_name, hlp) VALUES  (901, 'Поставить в очередь', 'Ставит в очередь выбранное задание');

INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (18, 901, 901, 0, 0);
...
INSERT INTO img_lnk (cur_page, tip, kod, img_url) VALUES  (0, 2, 901, 'send.png');

INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (12, 18, 901, null);

INSERT INTO role_pages (nzp_role, nzp_page) VALUES  (12, 18);
