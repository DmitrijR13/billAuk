...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (85, '~/kart/adres/splitls.aspx', 'Разделение лицевого счета', 'Разделение лицевого счета', 'переходит на форму разделения лицевого счета', 70, 70);


INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (85, 170, 170, 0, 0);

INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (85, 170, 85);
...
INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (10, 85, 170, null);

INSERT INTO role_pages (nzp_role, nzp_page) VALUES  (10, 85);
