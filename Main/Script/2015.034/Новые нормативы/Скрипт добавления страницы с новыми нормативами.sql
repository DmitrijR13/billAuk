...
INSERT INTO pages (nzp_page, page_url, page_menu, page_name, hlp, up_kod, group_id) VALUES  (8, '~/kart/prm/normatives.aspx', 'Нормативы(новые)', 'Нормативы(новые)', 'Предназначена для отображения и редактирования нормативов', 73, 73);

INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (8, 169, 141, 0, 0);
INSERT INTO actions_show (cur_page, nzp_act, sort_kod, act_tip, act_dd) VALUES  (8, 170, 170, 0, 0);

INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (8, 169, 8);
INSERT INTO actions_lnk (cur_page, nzp_act, page_url) VALUES  (8, 170, 8);
...
INSERT INTO s_roles (nzp_role, role, page_url, sort) VALUES  (918, 'Нормативы (Добавление)', 0, 918);

INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (918, 8, 169, null);
INSERT INTO role_actions (nzp_role, nzp_page, nzp_act, mod_act) VALUES  (918, 8, 170, null);

INSERT INTO role_pages (nzp_role, nzp_page) VALUES  (10, 8);
delete from role_pages where nzp_role=918 and nzp_page=8;
INSERT INTO roleskey (nzp_role, tip, kod) VALUES  (10, 105, 918);
