...
{
    public class KalugaFaktura2 : BaseFactura2
    {
        ...
        {
            get { return "Калуга стандартный "; }
        }

        public override string Code {get { return "1001"; }}

        public override string FileName { get { return "kaluga354.frx"; } }
