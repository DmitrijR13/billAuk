...
namespace STCLINE.KP50.DataBase
{
    ...
    /// </summary>
    public partial class DbDistribDomSuppServer : DataBaseHeadServer
    {
        /// <summary>
        ...
        public void FindDistribDom(MoneyDistrib finder, out Returns ret)
        {
            ...
            string insert = "Insert into " + tXXDistribDom_full +
                " (pref, year_, month_, nzp_payer, payer, nzp_payer_agent, agent, nzp_payer_princip, princip, nzp_payer_supp, supp, nzp_serv, service, nzp_dom, adr, nzp_bank, bank, dat_oper, dat_oper_po, sum_in, sum_rasp, sum_ud, sum_naud, sum_reval, sum_charge, sum_send, sum_out)";
            string select = " Select " + Utils.EStrNull(finder.pref) + "{year}{month}{payer}{agent}{princip}{supp}{service}{dom}{bank}{dat_oper}";
            ...
            using (DbDistribDomSuppClient db = new DbDistribDomSuppClient(finder.nzp_user))
            {
