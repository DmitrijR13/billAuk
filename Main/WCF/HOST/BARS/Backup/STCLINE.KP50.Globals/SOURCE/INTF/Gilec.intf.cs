...
namespace STCLINE.KP50.Interfaces
{
    ...
    //----------------------------------------------------------------------
    {
        ...
        // Для Самары
        [DataMember] public bool is_arx { get; set; }
...
// Для Самары
    ...
    //----------------------------------------------------------------------
    {
        [DataMember] public string nzp_sud  { get; set; }
        [DataMember] public string sud  { get; set; }
        [DataMember] public bool is_checked  { get; set; }
        [DataMember] public string nzp_gil  { get; set; }
        [DataMember] public string nzp_kart { get; set; }

        [DataMember] public string fam { get; set; }
        [DataMember] public string ima { get; set; }
        [DataMember] public string otch { get; set; }
        [DataMember] public string dat_rog { get; set; }
        [DataMember] public string dat_rog_po { get; set; }



        [DataMember] public string fam_c { get; set; }

        [DataMember] public string ima_c { get; set; }
        [DataMember] public string otch_c { get; set; }
        [DataMember] public string dat_rog_c { get; set; }
        [DataMember] public string gender { get; set; }
        [DataMember] public string grgd { get; set; }

        
        [DataMember] public string nzp_dok { get; set; }
        [DataMember] public string dok { get; set; }

        [DataMember] public string serij { get; set; }
        [DataMember] public string nomer { get; set; }
        [DataMember] public string vid_mes { get; set; }
        [DataMember] public string vid_dat { get; set; }
        [DataMember] public string vid_dat_po { get; set; }
        
        [DataMember] public string tprp { get; set; }

        [DataMember] public string jobpost { get; set; }
        [DataMember] public string jobname { get; set; }
        [DataMember] public string dat_pvu { get; set; }
        [DataMember] public string who_pvu { get; set; }

        [DataMember] public string dat_svu { get; set; }

        [DataMember] public string namereg { get; set; }
        [DataMember] public string kod_namereg_prn { get; set; }

        [DataMember] public string nzp_rod { get; set; }
        [DataMember] public string rod { get; set; }


        [DataMember] public string nzp_celp { get; set; }
        [DataMember] public string celp { get; set; }

        [DataMember] public string nzp_celu { get; set; }
        [DataMember] public string celu { get; set; }

        [DataMember] public string ndees { get; set; }
        [DataMember] public string neuch { get; set; }

        [DataMember] public string nzp_tkrt { get; set; }
        [DataMember] public string isactual { get; set; }

        [DataMember] public new string nzp_land { get; set; }
        [DataMember] public new string nzp_stat { get; set; }
        [DataMember] public new string nzp_town { get; set; }
        [DataMember] public string land { get; set; }
        [DataMember] public string stat{ get; set; }


        [DataMember] public string rajon_dom { get; set; }


        [DataMember] public string nzp_lnmr { get; set; }
        [DataMember] public string nzp_stmr { get; set; }
        [DataMember] public string nzp_tnmr { get; set; }
        [DataMember] public string nzp_rnmr { get; set; }
        [DataMember] public string lnmr { get; set; }
        [DataMember] public string stmr { get; set; }
        [DataMember] public string tnmr { get; set; }
        [DataMember] public string rnmr { get; set; }
        [DataMember] public string rem_mr { get; set; }

        [DataMember] public string nzp_lnop { get; set; }
        [DataMember] public string nzp_stop { get; set; }
        [DataMember] public string nzp_tnop { get; set; }
        [DataMember] public string nzp_rnop { get; set; }
        [DataMember] public string lnop { get; set; }
        [DataMember] public string stop { get; set; }
        [DataMember] public string tnop { get; set; }
        [DataMember] public string rnop { get; set; }
        [DataMember] public string rem_op { get; set; }
        ...
        [DataMember] public string nzp_lnku { get; set; }
        [DataMember] public string nzp_stku { get; set; }
        [DataMember] public string nzp_tnku { get; set; }
        [DataMember] public string nzp_rnku { get; set; }
        [DataMember] public string lnku { get; set; }
        [DataMember] public string stku { get; set; }
        [DataMember] public string tnku { get; set; }
        [DataMember] public string rnku { get; set; }
        [DataMember] public string rem_ku { get; set; }
        
        [DataMember] public string rem_p { get; set; }


        [DataMember] public string dat_prop { get; set; }
        [DataMember] public string dat_vip { get; set; }
        [DataMember] public string dat_oprp { get; set; }
        [DataMember] public string dat_oprp_po { get; set; }

        [DataMember] public string dat_ofor { get; set; }
        [DataMember] public string dat_ofor_po { get; set; }
        [DataMember] public string dat_sost { get; set; }
        [DataMember] public string dat_izm { get; set; }
        [DataMember]
        public string dat_izm_po { get; set; }
        
        [DataMember] public bool callFromFindLs; //вызов списка карточек из экрана поиска адресов, значит надо сначало найти список лс
        [DataMember] public List<KartGrgd> listKartGrgd { get; set; }
        [DataMember] public string nzp_serial { get; set; }
        
        [DataMember] public string kod_podrazd { get; set; }
        
        [DataMember] public string land_op { set; get; }
        [DataMember] public string stat_op { set; get; }
        [DataMember] public string town_op { set; get; }
        [DataMember] public string rajon_op { set; get; }

        [DataMember] public string no_get { set; get; }
        [DataMember] public string no_change { set; get; }

//Для Cамары
        [DataMember] public string strana_mr { set; get; }
        [DataMember] public string region_mr { set; get; }
        [DataMember] public string okrug_mr { set; get; }
        [DataMember] public string gorod_mr { set; get; }
        [DataMember] public string npunkt_mr { set; get; }


        [DataMember] public string strana_op { set; get; }
        [DataMember] public string region_op { set; get; }
        [DataMember] public string okrug_op { set; get; }
        [DataMember] public string gorod_op { set; get; }
        [DataMember] public string npunkt_op { set; get; }
        ...
        [DataMember] public string strana_ku { set; get; }
        [DataMember] public string region_ku { set; get; }
        [DataMember] public string okrug_ku { set; get; }
        [DataMember] public string gorod_ku { set; get; }
        [DataMember] public string npunkt_ku { set; get; }
        ...
        [DataMember] public string dat_smert { get; set; }

        [DataMember] public string dat_fio_c { get; set; }
        
        [DataMember] public bool is_arx { set; get; }
...
//Для Cамары
    ...
    {
        [DataMember]     public string nzp_kart { get; set; }
        [DataMember]     public string nzp_grgd { get; set; }
        [DataMember]     public string grgd { get; set; }
    ...
    //----------------------------------------------------------------------
    {
        [DataMember] public string name_sprav  { get; set; }
        [DataMember] public string nzp_sprav  { get; set; }
        [DataMember] public int parent_nzp_sprav { get; set; }
        [DataMember] public string val_sprav  { get; set; }
        [DataMember] public string dop_kod  { get; set; }
    ...
    //----------------------------------------------------------------------
    {
        [DataMember] public string nzp_glp  { get; set; }
        [DataMember] public string nzp_gilec  { get; set; }
        [DataMember] public string dat_s  { get; set; }
        [DataMember] public string dat_po  { get; set; }
        [DataMember] public string is_actual  { get; set; }
        [DataMember] public string sost  { get; set; }
        [DataMember] public string osnov  { get; set; }
        [DataMember] public string dat_when  { get; set; }
        [DataMember] public string dat_del  { get; set; }
    ...
    //----------------------------------------------------------------------
    {
        [DataMember] public string nzp_sobstw  { get; set; }
        [DataMember] public string nzp_gil  { get; set; }
        ...
        [DataMember] public string dop_info  { get; set; }
        ...
        [DataMember] public string dolya { get; set; }
        [DataMember] public string dolya_up  { get; set; }
        [DataMember] public string dolya_down  { get; set; }
        
        [DataMember] public string nzp_dok_sv  { get; set; }
        [DataMember] public string dok_sv  { get; set; }
        [DataMember] public string serij_sv  { get; set; }
        [DataMember] public string nomer_sv  { get; set; }
        [DataMember] public string vid_mes_sv  { get; set; }
        [DataMember] public string vid_dat_sv  { get; set; }
        [DataMember] public string is_actual  { get; set; }
        [DataMember] public string sost  { get; set; }
    ...
    //----------------------------------------------------------------------
    {
        [DataMember] public string nzp_kvar  { get; set; }
        [DataMember] public string nkvar  { get; set; }
        [DataMember] public string nkvar_n  { get; set; }
        [DataMember] public string nzp_dom  { get; set; }
        [DataMember] public string ndom  { get; set; }
        [DataMember] public string nkor  { get; set; }
        [DataMember] public string nzp_ul  { get; set; }
        [DataMember] public string ulica  { get; set; }
        [DataMember] public string ulicareg  { get; set; }
        [DataMember] public string nzp_raj { get; set; }
        [DataMember] public string rajon  { get; set; }
        [DataMember] public string nzp_town  { get; set; }
        [DataMember] public string town  { get; set; }
        [DataMember] public string nzp_stat  { get; set; }
        [DataMember] public string stat  { get; set; }
        [DataMember] public string nzp_land  { get; set; }
        [DataMember] public string land  { get; set; }
        [DataMember] public string nzp_raj_dom  { get; set; }
        [DataMember] public string rajon_dom  { get; set; }
