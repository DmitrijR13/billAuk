...
namespace KP50.DataBase.Migrator.Providers
{
    ...
    public class ProviderFactory
    {
        ...
        {
        { "PostgreSQL", "KP50.DataBase.Migrator.Providers.PostgreSQL.PostgreSQLTransformationProvider, KP50.DataBase.Migrator.Providers.PostgreSQL" },
        { "Informix", "KP50.DataBase.Migrator.Providers.Informix.InformixTransformationProvider, KP50.DataBase.Migrator.Providers.Informix" }
        };
