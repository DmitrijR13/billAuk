...
namespace KP50.DataBase.Migrator.Providers
{
    ...
    public class TypeMap
    {
        ...
        /// <summary>
        /// Äîáàâèòü çíà÷åíèå ïî-óìîë÷àíèþ äëÿ òèïà
        /// </summary>
        /// <param name="typecode">Òèï</param>
        ...
        /// <summary>
        /// Ïîëó÷èòü çíà÷åíèå ïî-óìîë÷àíèþ
        /// </summary>
        /// <param name="typecode">Òèï</param>
        /// <returns>
        /// Çíà÷åíèå ïî-óìîë÷àíèþ äëÿ äàííîãî òèïà.
        /// Åñëè çíà÷åíèå îïðåäåëèòü íå óäàëîñü, ãåíåðèðóåòñÿ èñêëþ÷åíèå.
        /// </returns>
        ...
        /// <summary>
        /// Ïîëó÷åíèå ñòðîêè SQL äëÿ òèïà ñ ó÷åòîì ðàçìåðîâ
        /// </summary>
        /// <param name="typecode">Òèï</param>
        /// <param name="size">Ðàçìåð</param>
        /// <returns>
        /// Âîçâðàùàåò ñòðîêó SQL äëÿ òèïà, îïðåäåëåííóþ ñ ó÷åòîì åãî ðàçìåðîâ.
        /// Åñëè ñòðîêó SQL îïðåäåëèòü íå óäàëîñü, âîçâðàùàåòñÿ null.
        /// </returns>
        ...
        /// <summary>
        /// Ðåãèñòðèðóåò íàçâàíèå òèïà ÁÄ, êîòîðîå áóäåò èñïîëüçîâàíî äëÿ
        /// êîíêðåòíîãî çíà÷åíèÿ DbType, óêàçàííîãî â "ìèãðàöèÿõ".
        /// <para><c>$l</c> - áóäåò çàìåíåíî íà êîíêðåòíîå çíà÷åíèå äëèíû</para>
        /// <para><c>$s</c> - áóäåò çàìåíåíî íà êîíêðåòíîå çíà÷åíèå, ïîêàçûâàþùåå 
        /// êîëè÷åñòâî çíàêîâ ïîñëå çàïÿòîé äëÿ âåùåñòâåííûõ ÷èñåë</para>ì
        /// </summary>
        ...
        /// <para><c>$l</c> - áóäåò çàìåíåíî íà êîíêðåòíîå çíà÷åíèå äëèíû</para>
        /// <para><c>$s</c> - áóäåò çàìåíåíî íà êîíêðåòíîå çíà÷åíèå, ïîêàçûâàþùåå 
        /// êîëè÷åñòâî çíàêîâ ïîñëå çàïÿòîé äëÿ âåùåñòâåííûõ ÷èñåë</para>
        /// </summary>
        /// <param name="typecode">Òèï</param>
        /// <param name="length">Ìàêñèìàëüíàÿ äëèíà</param>
        /// <param name="name">Íàçâàíèå òèïà ÁÄ</param>
        /// <param name="defaultScale">Çíà÷åíèå ïî-óìîë÷àíèþ: êîëè÷åñòâî çíàêîâ ïîñëå çàïÿòîé äëÿ âåùåñòâåííûõ ÷èñåë</param>
        ...
        /// <summary>
        /// Ïðîâåðêà, ÷òî çàäàííûé òèï çàðåãèñòðèðîâàí
        /// </summary>
        /// <param name="type">Ïðîâåðÿåìûé òèï</param>
