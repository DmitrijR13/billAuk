...
namespace KP50.DataBase.UpdateAssembly._2014._2014124
{
    ...
    // DD   - Day
    // VVV  - Version
    [Migration(2014122512401, MigrateDataBase.Charge)]
    public class Migration_2014122512401_Charge : Migration
    {
                        ...
                        if (Database.TableExists(calc_gku_xx))
                        {
                            if (!Database.ColumnExists(calc_gku_xx, "rashod_source"))
                            {
                                Database.AddColumn(calc_gku_xx,
                                    new Column("rashod_source", DbType.Decimal.WithSize(15, 7), ColumnProperty.NotNull,
                                        default(decimal)));
                            }
                        }
                    }
