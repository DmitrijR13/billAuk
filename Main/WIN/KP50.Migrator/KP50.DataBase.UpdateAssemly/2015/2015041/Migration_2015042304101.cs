...
insert into prm_tarifs (nzp_serv,nzp_frm,nzp_prm,is_edit,nzp_user,dat_when)
 ...
 from services where nzp_serv in (306,307,308,309,310,311);");
            ...
            Database.ExecuteNonQuery(@"delete from formuls_opis where nzp_frm = 1999;
insert into formuls_opis (nzp_frm, nzp_frm_kod, nzp_frm_typ, nzp_frm_typrs) values (1999, 1999, 1999, 4);");
