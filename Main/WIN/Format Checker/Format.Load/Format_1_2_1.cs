...
{
    [Assemble(FormatName = "Характеристики жилого фонда", Version = "1.2.1", RegistrationName = "Format 1.2.1")]
    public class Format20150325 : IFormat
    {
        /// <summary>
        ...
        public class FormatChecker : IFormatChecker
        {
                ...
                try
                {
                         ...
                         checkList["1"][0][1].Trim() == "1.2.1"))
                    {
                        ...
                        erList.Add(string.Format(
                            "Формат проверяемого файла ({0}), не совпадает с форматом проверки (1.2.1)",
            ...
            public override Dictionary<string, string> GetTemplatesHead()
            {
                return new Dictionary<string, string>
                {
                    ...
                    {"26", "ПАЧКИ РЕЕСТРОВ"},
                    {"27", "ЮРИДИЧЕСКИЕ ЛИЦА(АРЕНДАТОРЫ И СОБСТВЕННИКИ"},
            ...
            public override Dictionary<string, List<Template>> FillTemplates()
            {
                ...
                var allList = new Dictionary<string, List<Template>>
                {
                    ...
                    },
                    {
                        ...
                        {
                            new Template("Номер секции", Types.Int, 0, null),
                            new Template("Уникальный код УК", Types.Int, 1, null),
                            new Template("Наименование УК", Types.String, null, 100),
                            ...
                            new Template("Корреспондентский счет", Types.String, null, 20, false)
                        }
                    },
                    {
                        "3", new List<Template>
                    ...
                    },
                    {
                        "4", new List<Template>
                        {
                            ...
                            new Template(
                                ...
                                Types.String, null, 250, false),
                            new Template("Количество строк - услуга", Types.Int, 0, null,false),
                            new Template("Количество строк  – параметры в месяце перерасчета лицевого счета", Types.Int,
                                0, null,false),
                            new Template("Количество строк – индивидуальный прибор учета", Types.Int, 0, null,false),
                            new Template("Уникальный код ЮЛ", Types.String, 1, null, false, 1, "27")
                        }
                    },
                    {
                        "5", new List<Template>
                        {
                            new Template("Номер секции", Types.Int, 0, null),
                            new Template("Уникальный код поставщика", Types.Int, 1, null),
                            new Template("Наименование поставщика", Types.String, null, 100),
                            new Template("Юридический адрес", Types.String, null, 100,false),
                            new Template("Фактический адрес", Types.String, null, 100,false),
                            new Template("ИНН", Types.String, null, 20),
                            new Template("КПП", Types.String, null, 20),
                            new Template("Расчетный счет", Types.String, null, 20,false),
                            new Template("Банк", Types.String, null, 100, false),
                            new Template("БИК банка", Types.String, null, 20, false),
                            new Template("Корреспондентский счет", Types.String, null, 20, false)
                    ...
                    },
                    {
                        "6", new List<Template>
                        {
                            ...
                            new Template("Код поставщика услуг", Types.Int, null, null, true, 1, "5"),
                            ...
                            new Template("Количество строк – перерасчетов начисления по услуге", Types.Int, 0, null,false)
                        }
                    },
                    {
                        "7", new List<Template>
                    ...
                    },
                    {
                        "8", new List<Template>
                        {
                            ...
                            new Template("Месяц и год перерасчета", Types.DateTime, null, 14),
                            new Template("№ ЛС в системе поставщика", Types.String, null, 20, true, 3, "4"),
                            new Template("Код поставщика", Types.Int, 1, null,true,1,"5"),
                    ...
                    },
                    {
                        "11", new List<Template>
                        {
                            ...
                            new Template("Дополнительные характеристики прибора учета (заполняется в соответствии с форматом задания значений параметров)", Types.String, null, 250, false)
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        {
                            new Template("Номер секции", Types.Int, 0, null),
                            new Template("Уникальный код услуги в системе поставщика информации", Types.Int, null, null),
                    ...
                    },
                    {
                        "14", new List<Template>
                        {
                            ...
                            new Template("Код муниципального образования (КЛАДР)", Types.String, null, 30)
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        {
                            new Template("Номер секции", Types.Int, 0, null),
                            new Template("Уникальный код ЮЛ", Types.Int, null, null),
                            new Template("Наименование ЮЛ", Types.String, null, 100),
                            new Template("Юридический адрес", Types.String, null, 100,false),
                            new Template("Фактический адрес", Types.String, null, 100,false),
                            new Template("ИНН", Types.String, null, 12),
                            new Template("КПП", Types.String, null, 9),
                            new Template("Расчетный счет", Types.String, null, 20,false),
                            new Template("Банк", Types.String, null, 100,false),
                            new Template("БИК банка", Types.String, null, 20,false),
                            new Template("Корреспондентский счет", Types.String, null, 20,false),
                            ...
                            new Template("Ф.И.О. руководителя", Types.String, null, 100,false),
                            new Template("Должность руководителя", Types.String, null, 40,false),
                            new Template("Ф.И.О. Бухгалтера", Types.String, null, 100,false),
                            ...
                            new Template("Банк предприятия", Types.String, null, 100,false),
                            new Template("Адрес банка", Types.String, null, 100,false),
                            new Template("БИК", Types.String, null, 20,false),
                            new Template("Р/счет предприятия", Types.String, null, 20,false),
                            new Template("К/счет предприятия", Types.String, null, 20,false),
                            new Template("Должность + ФИО в родит. падеже (в лице кого)", Types.String, null, 100,false),
                        }
                    },
                    {
