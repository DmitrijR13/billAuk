...
//пример привязки к объекту пользовательского класса
//            myClass = new MyClass();
//            BindingSource bs = new BindingSource();
//            bs.DataSource = myClass;

//            Binding bb = new Binding("Value", bs, "MyProperty", true);
//            bb.DataSourceNullValue = null;
//            nullableDateTimePicker1.DataBindings.Add(bb);
//            dateTimePicker1.DataBindings.Add(bb);
