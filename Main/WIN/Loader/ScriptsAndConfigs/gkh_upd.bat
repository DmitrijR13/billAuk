...
echo ¬˚·‡Ì‡ ÒıÂÏ‡: %schema%, ‚˚·‡Ì‡ Ú‡·ÎËˆ‡: %table_name%
echo ¬˚ÔÓÎÌÂÌ˚ ÒÎÂ‰Û˛˘ËÂ ÓÔÂ‡ˆËË:
  ...
  if ERRORLEVEL 1 (
    ...
    echo ¬Õ»Ã¿Õ»≈.œ–Œ»«ŒÿÀ¿ Œÿ»¡ ¿ œ–» «¿√–”« ≈ ƒ¿ÕÕ€’: temp_%table_name% 
  ...
  if ERRORLEVEL 1 (
    ...
    echo ¬Õ»Ã¿Õ»≈.œ–Œ»«ŒÿÀ¿ Œÿ»¡ ¿ œ–» «¿√–”« ≈ ƒ¿ÕÕ€’.Œ¡–¿“»“≈—‹   –¿«–¿¡Œ“◊» ” 
