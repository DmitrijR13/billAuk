...
namespace STCLINE.KP50.Interfaces
{
    ...
    public interface I_Debitor
    {
        ...
        [OperationContract]
        string GetDebtorList(ChargeFind finder, out Returns ret);

        [OperationContract]
        Returns SaveDealChecked(List<Deal> finder);
    }

    public interface IDebitorRemoteObject : I_Debitor, IDisposable { }
    ...
    public class lawsuit_Data : Deal
    {
        ...
        [DataMember]
        public decimal lawsuit_price_peni { get; set; }
        [DataMember]
        public DateTime lawsuit_from { get; set; }
        [DataMember]
        public DateTime lawsuit_to { get; set; }
        [DataMember]
        public string decide_number { get; set; }
        [DataMember]
        public decimal dn_lawsuit_price { get; set; }
        [DataMember]
        public decimal dn_tax { get; set; }
        [DataMember]
        public DateTime dn_date { get; set; }
        [DataMember]
        public decimal dn_lawsuit_price_peni { get; set; }
        [DataMember]
        public DateTime il_date { get; set; }
        [DataMember]
        public string il_number { get; set; }
        [DataMember]
        public string il_where_directed { get; set; }
        [DataMember]
        public int is_executed { get; set; }
        public lawsuit_Data()
        {
            nzp_lawsuit = 0;
